...
HD_PWD='D:/Chip_Design/SEMESTER_2/Vivado/Project_02/06_CD4017B/06_CD4017B.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log CD4017B.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source CD4017B.tcl
